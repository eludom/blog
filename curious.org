...
*** PUBLISHED Hiking, the Appalachian Trail, Health and Choices :hiking:AppalachianTrail:ATC:PATC:Katahdin:
    :PROPERTIES:
        :EXPORT_HUGO_SECTION: Blog
...
*** WIP Getting started in life is harder right now :life:family:100DaysToOffload:
    :PROPERTIES:
        :EXPORT_HUGO_SECTION: Blog
...
*** WIP  Awesome online singing from Denmark to Australia, and social distancing too! :choir:music:singing:easter:sacredharp:harmoniasacra:100DaysToOffload:
    :PROPERTIES:
    :EXPORT_HUGO_SECTION: Blog
