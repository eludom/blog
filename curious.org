...
*** WIP Choosy Programmers Choose GIF :Wilhite:CompuServe:GIF:History:Computers:Emacs:Programming:
    :PROPERTIES:
...
**** Things Steve Wrote
  ...
  given up on writing at DEC10 ADA compiler (Steve is still writing
  ...
  CompuServe needed an AOL killer.  One of those projects succeeded.
